...
public class RauAnThanLa_Activity extends AppCompatActivity {

    ListView lvRATL;
    ArrayList<SanPham_Model> arrRATL;
    RATL_Adapter ratl_adapter;
    int idrl =0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rau_an_than_la);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RauAnThanLa_Activity.this, Cart_Activity.class);
    ...
    private void lvItemClick() {
        lvRATL.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplicationContext(),Detail_Activity.class);
                intent.putExtra("tt",arrRATL.get(position));
                startActivity(intent);
            }
        });
    }
                ...
                if(response != null){
                    try {
                        ...
                        for (int i =0;i<jsonArray.length();i++){
                            ...
                            arrRATL.add(new SanPham_Model(Id,Title,IdLoaiSanPham,Quantity,Price,ImgUrl,Status,NhaSX,SoLuotMua,PriceSave));
                            ratl_adapter.notifyDataSetChanged();
                        }
    ...
    private void addControls() {
        ...
        lvRATL = findViewById(R.id.lvRATL);
        arrRATL = new ArrayList<>();
        ratl_adapter = new RATL_Adapter(getApplicationContext(),arrRATL);
        lvRATL.setAdapter(ratl_adapter);
    }

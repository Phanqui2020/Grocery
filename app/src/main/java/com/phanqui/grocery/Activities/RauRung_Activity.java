...
import com.phanqui.grocery.Adapters.RR_Adapter;
...
public class RauRung_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rau_rung);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RauRung_Activity.this, Cart_Activity.class);
    ...
    private void lvItemClick() {
        lvRR.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplicationContext(),Detail_Activity.class);
                intent.putExtra("tt", arrRR.get(position));
                startActivity(intent);
            }
        });
    }
                ...
                if(response != null){
                    try {
                        ...
                        for (int i =0;i<jsonArray.length();i++){
                            ...
                            arrRR.add(new SanPham_Model(Id,Title,IdLoaiSanPham,Quantity,Price,ImgUrl,Status,NhaSX,SoLuotMua,PriceSave));
                            rr_adapter.notifyDataSetChanged();
                        }
    ...
    private void addControls() {
        ...
        lvRR = findViewById(R.id.lvRR);
        arrRR = new ArrayList<>();
        rr_adapter = new RR_Adapter(getApplicationContext(), arrRR);
        lvRR.setAdapter(rr_adapter);
    }

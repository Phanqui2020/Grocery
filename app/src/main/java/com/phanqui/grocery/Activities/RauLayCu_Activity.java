...
import com.phanqui.grocery.Adapters.RLC_Adapter;
...
public class RauLayCu_Activity extends AppCompatActivity {

    ListView lvRLC;
    ArrayList<SanPham_Model> arrRLC;
    RLC_Adapter rlc_adapter;
    int idrl =0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rau_lay_cu);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RauLayCu_Activity.this, Cart_Activity.class);
    ...
    private void lvItemClick() {
        lvRLC.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplicationContext(),Detail_Activity.class);
                intent.putExtra("tt", arrRLC.get(position));
                startActivity(intent);
            }
        });
    }
                ...
                if(response != null){
                    try {
                        ...
                        for (int i =0;i<jsonArray.length();i++){
                            ...
                            arrRLC.add(new SanPham_Model(Id,Title,IdLoaiSanPham,Quantity,Price,ImgUrl,Status,NhaSX,SoLuotMua,PriceSave));
                            rlc_adapter.notifyDataSetChanged();
                        }
    ...
    private void addControls() {
        ...
        lvRLC = findViewById(R.id.lvRLC);
        arrRLC = new ArrayList<>();
        rlc_adapter = new RLC_Adapter(getApplicationContext(), arrRLC);
        lvRLC.setAdapter(rlc_adapter);
    }
